...
// *Vector/Standard Template Library (STL):
// The vector is a dynamic array that can grow and shrink in size as needed. It is part of the C++ Standard Template Library (STL) and provides various built-in functions to manipulate the array easily without worrying about memory management.
